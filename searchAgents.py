...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        self.initialCornerVisited=(False,False,False,False)
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            # check if hit walls first, then check if it is corner
...
def cornersHeuristic(state, problem):
    ...
    for i in range(0,4):
        if not corners_visited[i]:
            distToFurthest=max(distToFurthest,abs(current_pos[0] - corners[i][0]) + abs(current_pos[1] - corners[i][1]))

    return distToFurthest
